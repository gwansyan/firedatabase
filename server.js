...
const SERVER_VERSION = 'RT7_PRODUCTION_FACE_MATCH_V11A_ESP32_FACE_GATE_RAILWAY_MATCH_OPENAI_LIVENESS';
...
app.post('/api/rt7/face/match', async (req,res) => {
  ...
  catch(e) { res.status(200).json({ ok:false, version:SERVER_VERSION, error:String(e.message || e), answer:'人臉辨識失敗，請確認 ESP32 Snapshot、Railway Face DB 與 Liveness 設定。' }); }
});
