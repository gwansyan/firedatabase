...
function onlineStatus(lastSeen){if(!lastSeen)return 'OFFLINE'; return (Date.now()-new Date(lastSeen).getTime())<60000?'ONLINE':'OFFLINE';}
...
app.listen(PORT,()=>console.log('[RT7_EDU_TEST_V1] http://localhost:'+PORT+'/edu'));
